...
<?php
$serviceSlugs = [
    'Web Development'        => 'Web%20Development%20service-details.php',
    'Software Development'   => 'Software%20Development%20service-details.php',
    'Managed Cloud Hosting'  => 'Managed_Cloud_Hosting.php',
    'SEO'                    => 'S.E.O%20service-details.php',
    'Data Analytics'         => 'Data%20Analytics%20service-details.php',
    'Digital Marketing'      => 'Digital%20Marketing%20service-details.php',
    'Website Optimization'   => 'Website%20Optimization%20service-details.php',
    'Mobile Development'     => 'Mobile%20Development%20service-details.php',
    'WordPress Development'  => 'Wordpress%20Development%20service-details.php',
    'SAP Consulting'         => 'SAP%20Consulting%20service-details.php',
    'IT Consulting'          => 'IT%20Consulting%20service-details.php',
    'AI Chatbot Development' => 'AI_Chatbot_Development.php',
];
$itemListElements = [];
$pos = 1;
foreach ($serviceSlugs as $name => $slug) {
    $itemListElements[] = [
        "@type"    => "ListItem",
        "position" => $pos++,
        "name"     => $name,
        "url"      => "https://www.cloudtechnologycomputing.com/services/" . $slug,
    ];
}
$ld = [
    ...
    "@graph"    => [
        [
            ...
            "description" => "Cloud technology, managed cloud hosting, AWS, Azure, cloud migration, cloud security, AI chatbots, SEO, web development, and mobile apps for small businesses in Houston, Texas, and beyond.",
            "url"         => "https://www.cloudtechnologycomputing.com/services.php",
            "serviceType" => "Cloud Computing, AI Chatbot Development, Web Development, SEO, Mobile App Development, Managed Cloud Services",
            "provider"    => [
                "@type" => "Organization",
        ...
        [
            ...
            "itemListElement" => [
                ...
                ["@type" => "ListItem", "position" => 2, "name" => "Services", "item" => "https://www.cloudtechnologycomputing.com/services.php"],
            ],
        ],
        [
            "@type"         => "ItemList",
            "name"          => "Cloud Technology Computing Services",
