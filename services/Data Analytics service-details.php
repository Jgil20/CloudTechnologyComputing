                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-6">
                        <div class="service-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/Dataanalytics.avif" alt="analytics cloud computing" width="636" height="592"   >   
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="driscription-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/DataNumbers.avif" alt="cloud computing and network security " width="1311" height="561"   >   
                        </div>
                    </div>
                ...
                <div class="row gy-5">
                    <div class="col-lg-6">
                        <div class="faq-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/SAPAnalyticsCloud.avif" alt="cloud computing application software " width="639" height="568"   >   
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-center">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-8">
                    <ul class="related-solutions-list">
                        <li><a href="/solutions/cloud-data-warehouse-small-business">Cloud Data Warehouse for Small Businesses</a></li>
                        <li><a href="/solutions/real-time-analytics-dashboards">Real-Time Analytics Dashboards</a></li>
                    </ul>
                </div>
            </div>
        </div>
