                ...
                <div class="row gy-5">
                    ...
                    <div class="col-lg-6">
                        <div class="service-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/SearchEngineOptimization.avif" alt="cloud computing software as a service saas " width="636" height="592"   >   
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="driscription-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/AdvertisingSolutions.avif" alt="cloud computing on premise " width="1311" height="561"   >   
                        </div>
                    </div>
                ...
                <div class="row gy-5">
                    <div class="col-lg-6">
                        <div class="faq-img magnetic-item">
                            <img loading="lazy" class="img-fluid" src="../assets/img/inner-pages/marketing.avif" alt="cloud computing and it" width="639" height="568"   >   
                        </div>
                    </div>
                    <div class="col-lg-6 d-flex align-items-center">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-8">
                    <ul class="related-solutions-list">
                        ...
                        <li><a href="/solutions/local-seo-houston-small-business">Local SEO for Houston Small Businesses</a></li>
                    </ul>
                </div>
            </div>
        </div>
