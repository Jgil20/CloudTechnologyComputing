...
<body class="home-dark2 tt-magic-cursor">
 ...
 <!-- Start header section -->
            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-6">
                    <div class="contact-content">
                        ...
                        <p>"🌐 Cloud Technology Computing | Est. Oct 6, 2023 | Texas-Based | Software Development Company 🚀 " The goal isn’t to build a website. The goal is to build your business!</p>
                        <div class="informations">
                            <div class="single-info">
                                <div class="icon">
                                    <i class="fas fa-map-marker-alt"></i>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-20">
                                    <div class="form-inner">
                                        ...
                                        <input id="contact-fname" name="fname" type="text" required autocomplete="given-name">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-20">
                                    <div class="form-inner">
                                        <label for="contact-lname">Last name</label>
                                        <input id="contact-lname" name="lname" type="text" required autocomplete="family-name">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 mb-20">
                                    <div class="form-inner">
                                        ...
                                        <input id="contact-phone" name="phone" type="tel" required pattern="[+0-9()\-\s]{7,}" autocomplete="tel">
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-20">
                                    <div class="form-inner">
    ...
    <div class="contact-map">
        <!-- TODO: replace with Google Maps Embed API iframe once API key is provisioned -->
        <iframe src="https://www.google.com/maps?q=4409+Caplin+St%2C+Houston%2C+TX+77026&output=embed"
  width="100%" height="100%"
  style="border:0;"
  loading="lazy"
  referrerpolicy="no-referrer-when-downgrade"
  title="Cloud Technology Computing office location at 4409 Caplin St, Houston, TX 77026">
</iframe>
    </div>
